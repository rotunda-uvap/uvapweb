        ...
        return (
         <section className="text-gray-700 body-font">
            <div className="container px-5 py-2 mx-auto">
                ...
                <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Join our Mailing List</h1>
                <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-white">Submit the form below to subscribe to our mailing list for updates on new releases</p>
                </div>
                ...
                <input type="submit" text="Submit" className="text-white bg-black border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg"></input>
                </form>
            </div>
     </section>
