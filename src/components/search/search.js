...
const Hit = ( {hit}) => <div className="py-4 border-b-2 border-gray-100"><Link to={`../title/${ hit.BookID }`} onclick="window.open(this.href,'_blank');return false;" className="hover:text-ceci-gray-mid"><h6 className="font-thin text-md text-ceci-gray-dark tracking-wide uppercase">{hit.Title}</h6>
