...
const uvafullimage = getImage(data.uvalogofull)
   ...
   return (
    <section className=" w-full md:w-3/4 lg:w-2/3 mx-auto py-5  text-ceci-gray-dark">
       ...
       <div id="1" className="col-span-2 lg:col-span-3 w-full py-5 place-content-center"><div className=" text-center pb-5"><GatsbyImage image={uvafullimage} alt="uva logo"width={500} height={119} className="homepageimage" loading="eager"/></div></div> 
...
<div className="font-serif py-2 text-lg text-xl max-w-sm text-right text-ceci-gray-mid">{subtitle}</div>
        ...
        <Link to={booklink}> <img width={200} height={112} src={cover} alt="feat book" className="drop-shadow-img homepageimage" loading="eager" /></Link></div>
          </div>
