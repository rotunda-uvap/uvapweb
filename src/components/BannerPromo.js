        ...
        <div className="py-15 bg-blue-500">
            <div className="container mx-auto px-6">
                <div className="container mx-auto px-6 py-10">
                    <Link to={'../../' + data.markdownRemark.frontmatter.relbook}>
                        ...
                        <h3 className="text-lg md:text-3xl font-light text-gray-200">{data.markdownRemark.frontmatter.body2}</h3>
                            ...
                            <Link to={'../../' + data.markdownRemark.frontmatter.relbook}><GatsbyImage image={getImage(data.primImg)} alt="featured cover" /></Link>
