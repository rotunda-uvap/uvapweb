...
<div className="flex flex-col items-center">
       ...
       <span className="text-sm text-gray-00 tracking-widest">{phone}</span>
         <a className="text-gray-500 py-2 text-sm inline-flex items-center tracking-widest" href={`mailto:${ clean_email }`}>Email {title}
