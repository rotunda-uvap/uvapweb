...
<section className="border-b-2 py-8">
...
<GoogleCalendar/>
  ...
  <section className="py-8 border-b-2">
       ...
       <section className="py-8 border-b-2 mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 ">
       ...
       <div className="flex flex-col">
         <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" className="w-8 h-8 self-center" viewBox="0 0 24 24">
              <path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg> 
<Link to={'recent-books'} className="text-2xl font-light">All New Releases</Link></div></button>
       <button className="text-gray-600">
         <div className="flex flex-col"><svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" className="w-8 h-8 self-center" viewBox="0 0 24 24">
