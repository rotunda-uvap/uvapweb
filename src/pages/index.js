...
<h5 className="text-center text-white tracking-wide uppercase"><Link to={'../black-history-sale'}>Celebrate Black History Month: Use code 10FEB22 for 30% off selected books through Feb 2022!</Link></h5>
</section>
