...
<h5 className="text-center text-white tracking-wide uppercase"><Link to={'../womens-history-sale'}>Celebrate Women's History Month: Use code 10Mar22 for 30% off selected books through Mar 2022!</Link></h5>
</section>
