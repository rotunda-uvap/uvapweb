 ...
 return (
  ...
  <div className="container px-5 py-12 mx-auto">
    <div className="flex flex-col text-center w-full mb-10">
       <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">About UVa Press</h1> 
      <p className="lg:w-3/3 mx-auto leading-relaxed text-base">< span dangerouslySetInnerHTML={{__html: pagedata.html}}/></p>
    </div>
