...
<div className="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128  md:flex-row md:items-center md:space-x-6">
        ...
        <div className="flex flex-col items-center w-full md:flex-row md:w-1/2">
            <div className="max-w-lg md:mx-12 md:order-2">
                ...
                <span className="my-2 ml-4 font-serif text-base text-center md:text-left text-gray-600 dark:text-gray-300">View the selection of books from our Spring 2022 list.</span>
                <div className="ml-4 flex flex-row py-5">
                <span className="font-thin text-lg text-gray-500"><a href={'../../spring22.pdf'}>
            Download Catalog<span className="inline-flex items-center mt-4">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                <path d="M5 12h14M12 5l7 7-7 7"></path>
              </svg></span>
              </a></span>
              <span className="font-thin text-lg ml-4 text-gray-500"><a href="https://www.edelweiss.plus/#catalogID=4662173&page=1">
