...
<div className="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128  md:flex-row md:items-center md:space-x-6">
        ...
        <StaticImage  src="../images/spring25.jpg" alt="current catalog cover" />
        </div>
        ...
        <div className="flex flex-col items-center w-full md:flex-row md:w-1/2">
            ...
            Download Catalog<span className="inline-flex items-center mt-4">
              ...
              <span className="font-thin text-lg ml-4 tracking-wide text-ceci-gray-mid"><a href="https://www.edelweiss.plus/#catalogID=5123446&page=1">
