...
export default function StaffList({ data }) {
 ...
 return (
        ...
        <Layout>
          ...
          <div className="w-full flex place-items-center"><StaticImage src="../images/staff.jpg" alt="photo of UVA Press Staff as of Oct 2022" quality="100" placeholder="blurred" className="mx-auto"/></div>
