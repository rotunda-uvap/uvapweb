...
export default function FFPage() {
 ...
 return (
      ...
      />
           ...
           <h4 className="hidden md:block pb-3 font-light font-sans leading-none ">Furnace and Fugue</h4>
          <h4 className="md:hidden pb-3 font-light leading-relaxed font-sans">Furnace and Fugue</h4>
          <h6 className="italic font-thin text-gray-600 tracking-wider">A Digital Edition of Michael Maier's "Atalanta fugiens" (1618) with Scholarly Commentary</h6>
          <h6 className="py-2 font-display">Edited by Tara Nummedal and Donna Bilak</h6>
          <section className="py-4">
              <ImgGallery filename_array={screenshots}/>
          </section>

          <section className="py-4"> <div className="flex flex-row pl-6 inline-flex items-center"> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M6.672 1.911a1 1 0 10-1.932.518l.259.966a1 1 0 001.932-.518l-.26-.966zM2.429 4.74a1 1 0 10-.517 1.932l.966.259a1 1 0 00.517-1.932l-.966-.26zm8.814-.569a1 1 0 00-1.415-1.414l-.707.707a1 1 0 101.415 1.415l.707-.708zm-7.071 7.072l.707-.707A1 1 0 003.465 9.12l-.708.707a1 1 0 001.415 1.415zm3.2-5.171a1 1 0 00-1.3 1.3l4 10a1 1 0 001.823.075l1.38-2.759 3.018 3.02a1 1 0 001.414-1.415l-3.019-3.02 2.76-1.379a1 1 0 00-.076-1.822l-10-4z" clip-rule="evenodd" />
</svg> <a href="https://furnaceandfugue.org/" className="py-7 font-thin pl-5">Go to Publication </a></div></section>
