...
exports.createSchemaCustomization = ({ actions }) => {
  ...
  exports.createPages = ({ graphql, actions }) => {
    ...
    createRedirect({ fromPath: '/title/10289', toPath: '/great-experiment/', isPermanent: true, redirectInBrowser: true, statusCode: 200 })
    // createRedirect({ fromPath: '/uvamagazine/', toPath: '/', isPermanent: true, redirectInBrowser: true })
